...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-zinc-50/50 to-white dark:from-zinc-950 dark:via-zinc-900/50 dark:to-zinc-950">
      {/* Hero Section */}
      <section className="relative container mx-auto px-6 pt-24 pb-32 max-w-5xl">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl text-zinc-600 dark:text-zinc-400 max-w-3xl leading-relaxed">
      ...
      <section className="container mx-auto px-6 py-24 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-8 border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm">
            <div className="space-y-4">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-zinc-100 dark:bg-zinc-800">
      ...
      <section id="work" className="container mx-auto px-6 py-24 max-w-5xl">
        <div className="space-y-12">
          ...
          <div className="space-y-8">
            {/* Cubby UI Project */}
            <Card className="group overflow-hidden border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 transition-all duration-300 hover:border-zinc-300 dark:hover:border-zinc-700 hover:shadow-lg">
              <div className="grid md:grid-cols-2 gap-8 p-8 sm:p-10">
                <div className="space-y-6">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-zinc-900 to-zinc-700 dark:from-zinc-100 dark:to-zinc-300 flex items-center justify-center text-white dark:text-zinc-900 font-bold text-lg">
                        CU
                      </div>
                ...
                <div className="relative aspect-video md:aspect-square rounded-lg bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-800 dark:to-zinc-900 overflow-hidden border border-zinc-200 dark:border-zinc-800">
